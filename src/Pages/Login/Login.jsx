...
const Login = () => {
  ...
  const handleLogin = (e) => {
    ...
    signInUser(email, password)
      ...
      .catch((error) => {
        console.error(error);
        setLoginError("Please check your Email/Password again!");
      });
  };
    ...
    <div className="min-h-screen bg-gray-100 py-6 flex flex-col justify-center sm:py-12">
      <div className="relative py-3 sm:max-w-xl sm:mx-auto">
        ...
        <div className="relative px-4 py-10 bg-white shadow-lg sm:rounded-3xl sm:p-20">
            ...
            <div className="divide-y divide-gray-200">
              <div className="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                <form onSubmit={handleLogin}>
                  ...
                  {loginError && (
                    <p className="lg:text-lg text-lg font-bold text-center lg:pt-6 pt-4 lg:pb-2 text-red-600">
                      {loginError}
                    </p>
                  )}
                  <button
                    type="submit"
                    className="bg-cyan-500 text-white rounded-md px-4 py-1 mt-5"
                  >
                    Login
                  </button>
                </form>
          ...
          <div className="w-full justify-center grid grid-cols-1 space-y-5">
            <button
